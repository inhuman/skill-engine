...
// (скилл справки, скилл поиска по вики, file-ticket), выписанные в этом синтаксисе,
...
//
// Этим заняты composite-скиллы: triage зовёт file-ticket, скилл поиска —
// скилл поиска по вики и graph-search. Без такого шага composite, получивший описание,
